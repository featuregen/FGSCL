...
try {
    ...
    $commands = [
        ...
        "ALTER TABLE library_books ADD COLUMN edition VARCHAR(50) NULL DEFAULT NULL AFTER isbn" => "Added edition to library_books",
        ...
        "ALTER TABLE library_books ADD COLUMN price DECIMAL(10,2) NULL DEFAULT 0.00 AFTER available_quantity" => "Added price to library_books",
